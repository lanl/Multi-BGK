...
void read_input(int *nspec, 
  ...
  *nspec = -1;
  ...
  while (strcmp(line,"Stop") != 0) {
    ...
    //set to 1 for coupling with background electron field with specified (in code, for now) eV
    //set to 2 to indicate that species 0 is electrons and to use B-Y cross section
