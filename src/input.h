...
void read_input(int *nspec, int *dims, int *Nx, double *Lx, int *Nv,
                ...
                double **velo_in, double **T_in, int *ecouple, double *Te_start,
                double *Te_end, int *CL_type, int *ion_type, int *MT_or_TR,
                double **n, double **u, double **T, int *dataFreq,
                int *outputDist, double *RHS_tol, int *BGK_type, double *beta,
                int *hydro_flag, int *input_data_file_flag,
