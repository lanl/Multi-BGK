...
void initialize_sol_load_inhom_file(int rank, int *Nx_ranks, int Nx_global, int nspec, double **n_oned, double ***v_oned, double **T_oned, char *input_file_data_filename);
