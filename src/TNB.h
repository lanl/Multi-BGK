...
void TNB_DD(double **f, double **f_out, int sp, int rank, int TNB_FLAG, double mu, double *n, double **v, double *T);

void TNB_DT(double **f, double **f_out, int sp, int sp2, int rank, int TNB_FLAG, double mu, double *n, double **v, double *T);
