...
int main() {
  ...
  implicitGetVelocitiesTemperaturesLinear(n, v, T, nu, m, dt, nspec,
                                          conserveFlag, vnew, vmix, Tnew, Tmix);
  ...
  */
  ...
  implicitGetVelocitiesTemperaturesNonlinear(n, v, T, m, dt, nspec,
  conserveFlag, vnew, vmix, Tnew, Tmix);
